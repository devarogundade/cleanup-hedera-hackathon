  ...
  const steps = [
    {
      ...
      description:
        "Connect your Hedera wallet to get started. Compatible with HashPack and other Hedera wallets - setup takes less than 2 minutes.",
    ...
    },
    {
      ...
      description:
        "Browse active cleanup rounds and choose the zones you want to support. View real locations on an interactive map.",
    ...
    },
    {
      ...
      description:
        "Select fractions and complete your donation using HBAR. All transactions are instant and transparent on the blockchain.",
    ...
    },
    {
      ...
      title: "Vote for NGOs",
      description:
        "Cast your vote to decide which NGO will execute the cleanup. Your voice matters in directing environmental action.",
    ...
    },
    {
      ...
      description:
        "Get unique NFTs for each fraction sponsored, plus earn XP and climb the leaderboard.",
    ...
    },
    {
      ...
      description:
        "Monitor your personal dashboard to see the real-world impact you've made. Watch as cleanup teams restore the environment.",
  ...
  const features = [
    {
      ...
      description:
        "Powered by Hedera's high-speed network with 3-5 second finality",
    ...
    },
    {
      ...
      description:
        "All donations and NGO actions are recorded on the blockchain",
    ...
    },
    {
      ...
      description:
        "Earn XP, level up, and collect unique NFTs as you make an impact",
    ...
    },
    {
      ...
      description:
        "Each round targets specific locations for focused environmental change",
      ...
      <main className="relative">
        ...
        <div className="container mx-auto px-4 sm:px-6 py-12 sm:py-20 relative">
          ...
          <div className="text-center mb-16 sm:mb-24 animate-fade-in">
            <Badge
              variant="outline"
              className="mb-6 px-4 py-2 border-primary/20"
            >
            ...
            <p className="text-base sm:text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed px-4">
              Making environmental impact has never been easier. Follow these
              simple steps to start cleaning the planet and earning rewards.
            </p>
          </div>
                  ...
                  >
                    ...
                    <div className="flex-1 flex justify-center">
                      <div className="relative group">
                        <div
                          className={`absolute inset-0 bg-gradient-to-br ${step.color} rounded-2xl sm:rounded-3xl blur-xl opacity-50 group-hover:opacity-75 transition-opacity`}
                        />
                        <div
                          className={`relative bg-gradient-to-br ${step.color} rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12 shadow-2xl transform group-hover:scale-105 transition-transform`}
                        >
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Win missions to earn XP and accumulate rewards. Only
                          winners get XP - lose and you'll need to continue or
                          claim your current XP.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="border-t border-border pt-8">
                  ...
                  <ul className="space-y-3">
                    ...
                    <li className="flex items-start gap-3">
                      <CheckCircle className="w-5 h-5 text-primary mt-0.5 flex-shrink-0" />
                      <span className="text-muted-foreground">
                        Collect <strong>trash items</strong> or plant{" "}
                        <strong>trees</strong> depending on mission type
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="w-5 h-5 text-primary mt-0.5 flex-shrink-0" />
                    ...
                    <li className="flex items-start gap-3">
                      <CheckCircle className="w-5 h-5 text-primary mt-0.5 flex-shrink-0" />
                      <span className="text-muted-foreground">
                        Win to progress to next scene and earn XP, or watch ads
                ...
                <div className="bg-primary/5 rounded-lg p-6 border border-primary/20">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Make at least one donation to unlock the Eco-Fighter
                        game and start earning XP through gameplay!
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary/10 via-primary/5 to-background border-2 border-primary/20">
            ...
            <div className="relative px-6 py-12 sm:p-16 text-center space-y-6">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto">
                Join thousands of contributors making a real difference in ocean
                cleanup and reforestation efforts.
              </p>
              <Link to={ROUTES.APP_ROUND(5)}>
                <Button
                  size="lg"
                  className="gap-2 bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 shadow-xl text-base sm:text-lg px-8 py-6 mt-4"
                >
                  Get Started Now
