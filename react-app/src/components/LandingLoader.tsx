  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gradient-to-br from-background via-primary/5 to-accent/5 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-40 right-20 w-96 h-96 bg-accent/20 rounded-full blur-3xl animate-float" style={{ animationDelay: "1s" }}></div>
        <div className="absolute top-1/2 left-1/2 w-80 h-80 bg-secondary/15 rounded-full blur-3xl animate-float" style={{ animationDelay: "2s" }}></div>
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center gap-8 px-4">
        ...
        <div className="relative">
          ...
          {/* Logo container */}
          <div className="relative w-24 h-24 rounded-2xl bg-gradient-primary shadow-glow flex items-center justify-center animate-glow-pulse">
          ...
          <Sparkles className="absolute -bottom-2 -left-2 w-5 h-5 text-accent animate-spin-slow" style={{ animationDelay: "1s" }} />
        </div>
